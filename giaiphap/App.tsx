...
import { startService, registerRobustHandler } from './src/services/robustPollingService';
  ...
  useEffect(() => {
    ...
    const subscription = AppState.addEventListener('change', async (nextAppState: AppStateStatus) => {
      if (nextAppState === 'active') {
        ...
        const { isServiceRunning, getServiceStats } = await import('./src/services/robustPollingService');
